...
def train_options():
    ...
    parser.add_argument("--encoder_pretrained_path", default=None, type=str, help='path to pretrained CoBert')
    parser.add_argument("--model_pretrained_path", default=None, type=str, help='path to pretrained CoBertCRF')
